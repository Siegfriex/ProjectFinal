...
except Exception:  # Δ46-exit2 / Δ50-exit2-common: module-level script — crash / missing git object = did not run
    import traceback
    traceback.print_exc()
    print("preflight_sampling: did not run — read neither as pass nor fail (exit 2)", file=sys.stderr); sys.exit(2)
