...
## Files
- `fixtures/*.html` — 16 self-contained mobile pages (14 r2 + 2 r3) (390×844, inline CSS/JS/SVG, data-URI only). Exactly one `[data-c-target=entry]`
...
## measure_geometry.py output (run r3 2026-08-28 after fe33eae: +2 fixtures, per-step container chain, naive-DOM vs AX channels; chromium headless, Playwright, file:// only)
```
fixture                                         | ctl | visible        | ax_name        | ax_src          | modality            | relation     | ctype       | s0 | dir    | dx   | dy   | zone(R7) | band       | x,y       | observed_state            | chain                     | domax | naive  | result
----------------------------------------------- | --- | -------------- | -------------- | --------------- | ------------------- | ------------ | ----------- | -- | ------ | ---- | ---- | -------- | ---------- | --------- | ------------------------- | ------------------------- | ----- | ------ | ------
...
RESULT: 16/16 PASS, non-file requests aborted total=0
```
