...
RQ_SPEC = {
    ...
    "RQ-D13": ("LA_07_COLLECTION", "H-D13-DUP-MEASUREMENT-VECTOR",
               "wtg dedup 이 놓치는 중복이 몇 건이며 수집기 결함인가 frame 문제인가",
               None, "observation(66) / wtg(59) / distinct URL(56) / mart row(56)"),
