...
def run_eda05(
    ...
    *,
    ...
    if task.empty:
        ...
        summary: dict = {"n_tasks": 0, "by_archetype": {}, "auth_gate": {}}
    else:
        task["excess_depth"] = excess_depth(task["MPFED"], task["interaction_archetype"])
    ...
    body = [
        ...
        " — 과소집계 재현, A2 §1.5.1a)",
        f"- ExcessDepth(= MPFED - archetype median) 분포: {summary.get('excess_depth')}",
...
def _main() -> None:
    ...
    parser.add_argument("--out-dir", default="artifacts/analysis_skeleton/eda/eda05")
